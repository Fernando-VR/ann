...
class Matrix{
    ...
    public:
        ...
        Matrix applyFunction(std::function<double(const double&)> func){
        ...
        double &at(u_int32_t col, u_int32_t row) {
        ...
        Matrix multiplyScaler(double s) {
            Matrix output(_cols, _rows);
